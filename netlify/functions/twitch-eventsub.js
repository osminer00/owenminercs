...
exports.handler = async function handler(event) {
  ...
  try {
    const idempotentResult = await upstashCommand(["SET", idempotencyKey, "1", "NX", "EX", "86400"]);
    ...
    return json(500, { error: "Failed to persist Twitch event.", detail: String(error.message || error) });
  }
