...
- `npm run format:check` is currently noisy on many pre-existing files. For scoped docs-only changes, run Prettier/checks on the changed files and do not mass-format unrelated source.
