...
- X top-post sync must fail closed on empty upstream results: do not overwrite non-empty `Socials/data/x-top-posts.json` with `[]` when Nitter/fxTwitter has an outage or handle lookup returns no usable posts.
