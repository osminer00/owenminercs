...
- Shared header search depends on deployable `search.html` and `data/site-search-index.json`; when changing search nav/API, keep the route, index, `build:search`, sitemap, and regression test together.
