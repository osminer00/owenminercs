...
- Public generated indexes must not include gitignored scratch HTML or missing page paths; `data/site-search-index.json` is guarded by `test/search-index-regression.test.mjs`.
