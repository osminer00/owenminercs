...
- Shared header/nav links must ship with their backing static page/data assets. A search nav link once shipped without `search.html` or `data/site-search-index.json`, causing a site-wide 404.
