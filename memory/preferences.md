...
- **Main nav return helper:** after navigating with a header/footer main-nav pill, show a floating "Return to where you were" button on the destination page; clicking should jump back to the previous nested page and restore the saved scroll position.
