...
This folder is the shared, low-token memory layer for Codex, Claude, Cursor, Gemini, Antigravity, Ollama, and any future assistant.

Use it like a growing project brain:

- `project-state.md` - current repo map, commands, deployment notes
- `preferences.md` - durable user/site preferences
