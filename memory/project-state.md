...
- `SHARED_COMPONENTS_GUIDE.md` documents `scripts/components.js` + `css/owenminercs.css` shared chrome, including primary nav active-state/return-helper behavior, Keyboard 60HE hub routing, and social dock mount/persistence/drag behavior.
