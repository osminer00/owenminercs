...
const assistantReady = !!(assistantForm && assistantInput && assistantMessages && assistantStatus);
...
async function onSubmit(event) {
	...
	try {
		...
		pushMessage('assistant', 'I hit an error while answering. Please try again in a moment.');
