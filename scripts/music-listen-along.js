...
function renderNowPlaying(data) {
  ...
  const statusText = data.isPlaying ? "Live now playing" : "Spotify connected - waiting for next track";
...
function renderSuggestions(items) {
  ...
  if (!items.length) {
    suggestionList.innerHTML = '<li class="music-suggestions__empty">No suggestions yet. Be the first one.</li>';
    return;
  }
